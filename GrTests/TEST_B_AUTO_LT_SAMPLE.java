...
public class TEST_B_AUTO_LT_SAMPLE extends LinearOpMode {
    ...
    final double CHOPPING = 15*LIFT_TICKS_PER_MM;
    ...
    public void runOpMode() {
        ...
        ElapsedTime timer2 = new ElapsedTime();
          ...
          stopMotion();
            //towards sample
            movement("stRight", 0.8, 19, 10);
            
            //extend slider to position then chopping
            
            liftPosition = CHOPPING;
           liftMotor.setTargetPosition ((int)liftPosition);
           sleep(100);
           intake.setPower(INTAKE_COLLECT);
           armPosition = 0;
